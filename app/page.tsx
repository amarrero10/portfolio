...
function CountUp({ end, suffix, duration = 1800, started }: { end: number; suffix: string; duration?: number; started: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          AM<span style={{ color: 'var(--clr-green)' }}>.</span>
        </a>
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            <div className="flex flex-col py-6" style={{ paddingInline: 'var(--pad-x)', gap: '1.25rem' }}>
              {links.map((link) => (
                <a
                  key={link}
                  href={`#${link.toLowerCase()}`}
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: '60vw',
          background:
            'radial-gradient(circle, rgba(121,243,182,0.07) 0%, transparent 65%)',
          filter: 'blur(40px)',
        }}
      />
      ...
      <div style={{ paddingInline: 'var(--pad-x)' }}>
        ...
        >
          <span style={{ width: '2rem', height: '1px', background: 'var(--clr-green)', display: 'block' }} />
          <span
            style={{
              fontFamily: 'var(--ff-1)',
              fontSize: 'var(--text-xs)',
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          ...
          >
            I build performant, scalable web applications — from pixel-perfect frontends to
            robust backend systems. Based in the US, shipping worldwide.
          </motion.p>
      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            <motion.span
              ...
              style={{ width: '8px', height: '8px', borderRadius: '50%', background: 'var(--clr-green)', display: 'block', flexShrink: 0 }}
            />
            <span style={{ fontFamily: 'var(--ff-1)', fontSize: '0.7rem', color: 'var(--clr-green)', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
              Available for Work
            </span>
          </div>
          <p style={{ fontFamily: 'var(--ff-1)', fontSize: '0.72rem', color: 'var(--clr-text-2)', lineHeight: '1.5' }}>
            Open to full-time &amp; freelance<br />projects worldwide.
          </p>
        </div>
        <div
          style={{
        ...
        >
          <span style={{ fontFamily: 'var(--ff-2)', fontSize: 'var(--h4)', color: 'var(--clr-white)', lineHeight: 1 }}>5+</span>
          <span style={{ fontFamily: 'var(--ff-1)', fontSize: '0.7rem', color: 'var(--clr-text-2)', textTransform: 'uppercase', letterSpacing: '0.08em', lineHeight: '1.4' }}>
  ...
  return (
    ...
    >
      <div style={{ paddingInline: 'var(--pad-x)' }}>
        ...
        {/* Two columns */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20" style={{ marginBottom: 'var(--sp-sm)' }}>
          <motion.div
          ...
          >
            ...
            >
              A passionate full-stack developer with a sharp eye for design and a deep love
              for clean, maintainable code. I work across the entire stack — from database
              schema to pixel-perfect UI — to deliver products that perform and delight.
            </p>
          ...
          <motion.div
            ...
            style={{ position: 'relative', aspectRatio: '4/3', overflow: 'hidden', background: 'var(--clr-grey)' }}
          >
            <img
              src="https://placehold.co/800x600/2a2a2a/79F3B6?text=Developer+at+Work"
            ...
            <div
              style={{
                position: 'absolute',
                inset: 0,
                background: 'linear-gradient(135deg, rgba(121,243,182,0.08) 0%, transparent 60%), linear-gradient(to bottom, transparent 50%, var(--clr-light-black))',
              }}
            />
          </motion.div>
        </div>
        ...
        >
          {stats.map((stat, i) => (
            ...
            >
              ...
              >
                <CountUp end={stat.end} suffix={stat.suffix} duration={1600 + i * 200} started={statsInView} />
              </div>
              <div
                style={{
                  fontFamily: 'var(--ff-1)',
            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-3 md:gap-8">
                <h3
                  ...
                  className="group-hover:text-[#79F3B6]"
                >
                  {svc.title}
                </h3>
                <p
...
function Clients() {
  ...
  const clients = ['Acme Corp', 'FinTech Co', 'MediaHouse', 'RetailBrand', 'HealthTech', 'EduPlatform']
...
function FAQ() {
  ...
  return (
    <section
      ref={ref}
      style={{ background: 'var(--clr-black)', paddingBlock: 'var(--sp-xxl)' }}
    >
      <div style={{ paddingInline: 'var(--pad-x)' }}>
        <div
